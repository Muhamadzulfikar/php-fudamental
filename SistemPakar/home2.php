...
if(isset($_POST[$row1["kode_gejala"]])){
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g07'");
...
elseif (isset($_POST[$row2["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g14'");
...
elseif (isset($_POST[$row3["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g17'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p03'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g16'");
...
elseif (isset($_POST[$row4["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g20'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p04'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g19'");
...
elseif (isset($_POST[$row5["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g24'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p05'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g23'");
...
elseif (isset($_POST[$row6["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g28'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p06'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g27'");
...
elseif (isset($_POST[$row7["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g35'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p07'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g34'");
...
elseif (isset($_POST[$row8["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g38'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p08'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g37'");
...
elseif (isset($_POST[$row9["kode_gejala"]])) {
    $data = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g41'");
    $penyakit = mysqli_query($con, "SELECT nama_penyakit,kode_penyakit FROM penyakit where kode_penyakit = 'p09'");
    $data2 = mysqli_query($con, "SELECT nama_gejala,kode_gejala FROM gejalas where kode_gejala = 'g40'");
...
?>
    <section>
        <div class="container pb-16">
            ...
            <form method="post" action="home3.php">
